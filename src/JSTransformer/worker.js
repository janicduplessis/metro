...
class JsTransformer {
  ...
  transform(filename, data, options) {
    ...
    return _asyncToGenerator(function*() {
      ...
      const disableES6Transforms =
        (_options$unstable_dis = options.unstable_disableES6Transforms) !==
          null && _options$unstable_dis !== void 0
          ? _options$unstable_dis
          : false;
      ...
      if (filename.endsWith(".json")) {
        ...
        if (options.minify) {
          var _ref = yield _this._minifyCode(
            filename,
            code,
            sourceCode,
            map,
  ...
  _minifyCode(filename, code, source, map, disableES6Transforms) {
    var _this2 = this;
    ...
    return _asyncToGenerator(function*() {
      ...
      try {
        const minified = minify({
          ...
          filename,
          reserved,
          config: _objectSpread({}, _this2._config.minifierConfig, {
